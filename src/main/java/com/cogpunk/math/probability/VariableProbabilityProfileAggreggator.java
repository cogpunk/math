...
public class VariableProbabilityProfileAggreggator<E, P extends Number> implements ProbabilityProfile<E, P> {
	...
	public VariableProbabilityProfileAggreggator(ProbabilityProfile<Integer, P> repeatProbabilityProfile,
