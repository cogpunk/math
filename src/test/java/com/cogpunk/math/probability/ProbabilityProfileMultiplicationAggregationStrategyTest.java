...
public class ProbabilityProfileMultiplicationAggregationStrategyTest {
	...
	public void testAggregate() {
		...
		assertEquals((Integer) 720, new ProbabilityProfileMultiplicationAggregationStrategy<Integer>(new IntegerOperator()).aggregate(Arrays.asList(args)));
